    ...
    <div class="layui-card">
            ...
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-block">
                        <input type="text" id="carNo" placeholder="请输入" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-inline">
                    <label class="layui-form-label" style="width:100px ">车辆类型</label>
                    <div class="layui-input-block">
                        <input type="text" id="carType" placeholder="请输入" autocomplete="off" class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-inline" >
                    <label class="layui-form-label" style="width:100px ">车辆容积</label>
                    <div class="layui-input-block">
                        <input type="text" id="carSize" placeholder="请输入" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <br>
                <div class="layui-inline">
                    ...
                    <div class="layui-input-block">
                        <input type="text" id="tonnage" placeholder="请输入" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-inline">
                    <label class="layui-form-label" style="width:100px ">购买时间</label>
                    <div class="layui-input-block">
                        <input type="text"  id="buyTime" placeholder="请输入" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-inline">
                    <label class="layui-form-label" style="width:100px ">车辆状态</label>
                    <div class="layui-input-block">
                        <input type="text" id="carState" placeholder="请输入" autocomplete="off" class="layui-input">
                    </div>
                </div>

                <div class="layui-inline">
                    <label class="layui-form-label"style="width:100px ">运营线路</label>
                    <div class="layui-input-block">
                        <input type="text"  id="line" placeholder="请输入" autocomplete="off" class="layui-input">
                    </div>
                </div>
        ...
        <div class="layui-card-body">
            <div style="padding-bottom: 10px;">
                ...
                <button class="layui-btn layuiadmin-btn-admin" data-type="add">新购车辆登记</button>
            </div>
    ...
    <div class="modal-dialog" style="width: 480px"  role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">新购车辆登记</h4>
            </div>
    ...
    layui.config({
        ...
        table.render({
            ...
            , cols: [[
                ...
                , {field: 'carNo', title: '车辆编号',  sort: true, edit: true, align:'center'}
                , {field: 'carType', title: '车辆类型',  edit: true, align:'center'}
                , {field: 'carSize', title: '车辆容积（立方米）', edit: true, align:'center'}
                , {field: 'tonnage', title: '车辆吨位（吨）',sort: true, edit: true, align:'center'}
                , {field: 'buyTime', title: '购买时间',edit: true, align:'center'}
                , {field: 'carState', title: '车辆状态',edit: true, align:'center'}
                , {field: 'line', title: '运营线路',  edit: true, align:'center'}
                ...
                layer.prompt({
                    ...
                    if (value === '123') {
                        ...
                        layer.confirm('真的删除这条数据么', function (index) {
                            ...
                            var params = "method=delete&carid=" + data.carId
        ...
        function delBatch() {
            ...
            $.each(data, function (i, item) {
                if (i === 0) {
                    ...
                    params += "method=deleteBatch&carid=" + item.carId;
                } else {
        ...
        $("#dosearch").click(function () {
            ...
            table.reload('table',{
                ...
                where: {
                    ...
                    'car_no':$("#carNo").val(),
                    'c3.name':$('#carType').val(),
                    'car_size':$('#carSize').val(),
                    'tonnage':$('#tonnage').val(),
                    'buytime':$('#buyTime').val(),
                    'c2.name':$('#carState').val(),
                    'l.name':$('#line').val(),
